...
public class TestSolrJ {
    ...
    public void testSolrJAddDocument() throws Exception {
        ...
        SolrServer solrServer = new HttpSolrServer("http://39.108.0.169:8088/solr");
    ...
    @Test public void testQueryDocument() throws Exception {
        SolrServer solrServer = new HttpSolrServer("http://39.108.0.169:8088/solr");
        // 创建一个SolrQuery对象
        SolrQuery query = new SolrQuery();
        query.setQuery("手机");
